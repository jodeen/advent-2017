...
handleChar (False, False, depth, count) '<' = (True, False, depth, count)
handleChar (True, False, depth, count) '>' = (False, False, depth, count)
handleChar (True, False, depth, count) _ = (True, False, depth, count+1)
handleChar (False, False, depth, count) '{' = (False, False, depth + 1, count)
handleChar (False, False, depth, count) '}' = (False, False, if depth > 0 then depth - 1 else depth, count)
